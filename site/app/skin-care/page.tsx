        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-8 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <h2 className="font-serif text-ivory text-[clamp(2.5rem,5vw,4rem)] leading-[1.1] mb-8">
                Medical-Grade Products<br />for <span className="italic">Better Results</span>
              </h2>
              <div className="w-12 h-px bg-gold/40 mb-10" />
              <p className="text-ivory/50 text-[15px] font-sans font-light leading-[1.9] mb-6">
                Dr. Chavez uses AlumierMD and Derma Made in every in-office treatment. These are professionally dispensed lines, not available at retail, chosen because they match the clinical standards of the practice.
              </p>
              <p className="text-ivory/35 text-sm font-sans font-light leading-[1.9] mb-10">
                You can continue using them at home through Illari Aesthetics.
              </p>
              <Link
                href="/products"
            ...
            <div className="grid grid-cols-2 gap-px">
              {[
                { name: "AlumierMD", desc: "Professional-grade skincare formulated for medical practices" },
                { name: "Derma Made", desc: "Physician-dispensed solutions for targeted skin concerns" },
              ].map((brand) => (
                <div key={brand.name} className="bg-dark/60 backdrop-blur-sm p-8 text-center">
                  <p className="font-serif text-gold text-2xl mb-3">{brand.name}</p>
                  <p className="text-ivory/30 text-xs font-sans font-light leading-[1.7]">{brand.desc}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[500px]">
            ...
            <div className="relative h-[300px] lg:h-auto">
              <Image
                ...
                className="object-cover"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-transparent to-dark/90 hidden lg:block" />
              <div className="absolute inset-0 bg-gradient-to-b from-transparent to-dark/80 lg:hidden" />
            </div>
            ...
            <div className="flex flex-col justify-center px-8 lg:px-16 py-16 lg:py-24">
              ...
              <h2 className="font-serif text-ivory text-[clamp(2.5rem,5vw,4rem)] leading-[1.05] mb-6">
                Schedule Your Skin<br />Consultation in <span className="italic">Chicago</span>
              </h2>
