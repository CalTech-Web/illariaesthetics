    ...
    <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300">
      <div
        className={`max-w-6xl mx-auto transition-all duration-300 ${
          scrolled
            ? "mt-0 mx-0 max-w-full bg-dark/95 backdrop-blur-sm border-b border-gold/10"
            : "mt-4 mx-4 lg:mx-auto bg-dark/40 backdrop-blur-md rounded-sm border border-white/10"
        }`}
      >
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center space-x-6">
              ...
              <div className="relative group">
                <button className="text-white/80 hover:text-gold text-xs tracking-widest uppercase transition-colors flex items-center gap-1">
                  Services
        ...
        {/* Mobile Menu */}
        {isOpen && (
          <div className="lg:hidden bg-dark-medium/95 backdrop-blur-sm border-t border-gold/20">
