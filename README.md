...
```
WORK=/Users/brandonhopkins/Projects/illariaesthetics/agents/design-agent MODEL="sonnet" MAX_LOOPS=5 bash ~/Projects/claude-lab/ENGINE/run.sh
```
```
WORK=/Users/brandonhopkins/Projects/illariaesthetics/agents/content-agent MODEL="sonnet" MAX_LOOPS=5 bash ~/Projects/claude-lab/ENGINE/run.sh
```
```
WORK=/Users/brandonhopkins/Projects/illariaesthetics/agents/seo-agent MODEL="sonnet" MAX_LOOPS=5 bash ~/Projects/claude-lab/ENGINE/run.sh
```
```
WORK=/Users/brandonhopkins/Projects/illariaesthetics/agents/pagespeed-agent MODEL="sonnet" MAX_LOOPS=2 bash ~/Projects/claude-lab/ENGINE/run.sh
```
